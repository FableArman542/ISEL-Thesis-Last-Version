...
\begin{table}[h!]
    \centering
    \caption{Comparison of Popular Game Engines}
    \label{tab:game_engines_comparison}
    \resizebox{\textwidth}{!}{
    \begin{tabular}{|l|l|l|l|l|l|}
    \hline
    \textbf{Feature}           & \textbf{Unity}                    & \textbf{Unreal Engine}          & \textbf{Godot}                    & \textbf{Game Maker}              & \textbf{LibGDX}                  \\ \hline
    \textbf{Previous Experience} & 5+ years                & None             & None                 & None                & None       \\ \hline
    \textbf{Supported Languages} & C\#, UnityScript (deprecated)    & C++, Blueprints (visual scripting) & GDScript, C\#, VisualScript       & GML (Game Maker Language)        & Java, Kotlin                     \\ \hline
    \textbf{2D/3D}             & Both                             & Primarily 3D, supports 2D       & Both                              & Primarily 2D, limited 3D         & Both                             \\ \hline
    \textbf{Platforms Supported} & PC, Mobile, Console, Web, AR/VR & PC, Mobile, Console, AR/VR      & PC, Mobile, Console, Web          & PC, Mobile, Console              & PC, Mobile, Console, Web         \\ \hline
    \textbf{License Cost}      & Free (Personal), Paid (Pro)      & Free (limited), Paid tiers      & Free (MIT License)                & Paid (one-time or subscription)  & Free (Open Source)               \\ \hline
    \textbf{Ease of Use}       & High                             & Moderate                        & High                              & High                             & Moderate                         \\ \hline
    \textbf{Community Support} & Very Large                      & Very Large                      & Growing                           & Moderate                         & Moderate                         \\ \hline
    \end{tabular}
    }
    \end{table}
